...
const LandingScreen: React.FC = () => {
  ...
  return (
    ...
    >
      <SkinToneStrip />
      <main className="flex-1 flex flex-col items-center justify-between px-4 py-4 safe-top safe-bottom">
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-5xl mx-auto mb-4">
            {valueProps.map((prop, index) => (
              ...
              >
                ...
                <div className="relative bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 p-4 sm:p-6 h-full transform hover:-translate-y-1 transition-transform duration-300">
                  <div className="flex flex-col items-center text-center">
                    <h3 className="text-lg sm:text-xl font-medium text-white mb-2">{prop.title}</h3>
      ...
      <motion.footer
        className="relative z-20 w-full py-3 px-4 border-t border-gray-800/50 bg-gray-900/80 backdrop-blur-sm"
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
